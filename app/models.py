...
class Students(db.Model):
    ...
    day242 = db.Column(db.Boolean, default=False)
    day243 = db.Column(db.Boolean, default=False)
    day244 = db.Column(db.Boolean, default=False)
    day251 = db.Column(db.Boolean, default=False)
    day252 = db.Column(db.Boolean, default=False)
    day253 = db.Column(db.Boolean, default=False)
    day254 = db.Column(db.Boolean, default=False)
    day261 = db.Column(db.Boolean, default=False)
    day262 = db.Column(db.Boolean, default=False)
    day263 = db.Column(db.Boolean, default=False)

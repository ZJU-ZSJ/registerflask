...
def download():
    ...
    ws.write(0, 9, "第二志愿理由")
    ws.write(0, 10, "专业")
    ws.write(0, 11, "是否服从调剂")
    ws.write(0, 12, "9.25晚")
    ws.write(0, 13, "9.26晚")
    ws.write(0, 14, "9.27晚")
    ws.write(0, 15, "9.28晚")
    ws.write(0, 16, "9.29下午")
    ws.write(0, 17, "9.29晚")
    ws.write(0, 18, "9.30下午")
    ws.write(0, 19, "备注")
    ws.write(0, 20, "个人简介")
    ws.write(0, 21, "加入协会理由")
    ws.write(0, 22, "带来什么")
    ...
    for stu in re:
        ...
        ws.write(x, 6, stu.question3)
        ws.write(x, 7, stu.whywants1)
        ws.write(x, 8, stu.question4)
        ws.write(x, 9, stu.whywants2)
        ws.write(x, 10, stu.major)
        ws.write(x, 11, stu.question5)
        ws.write(x, 12, stu.day25)
        ws.write(x, 13, stu.day26)
        ws.write(x, 14, stu.day27)
        ws.write(x, 15, stu.day28)
        ws.write(x, 16, stu.day291)
        ws.write(x, 17, stu.day29)
        ws.write(x, 18, stu.day30)
        ws.write(x, 19, stu.remarks)
        ws.write(x, 20, stu.intro)
        ws.write(x, 21, stu.why)
        ws.write(x, 22, stu.what)
        x += 1
    w.save('record.xls')

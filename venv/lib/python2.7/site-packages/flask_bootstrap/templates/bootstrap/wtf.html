...
{% else -%}
  ...
  ">
      ...
      <small class="form-text text-warning"><font color="blue">{{error}}</font></small>
            {% endcall %}
          {%- endfor %}
        {%- elif field.description -%}
          {% call _hz_form_wrap(horizontal_columns, form_type, required=required) %}
      <small class="form-text text-warning"><font color="blue">{{field.description|safe}}</font></small>
          {% endcall %}
        {%- endif %}
      {%- else -%}
